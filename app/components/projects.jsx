        ...
        <section className="projects" id="projects">
            <div className="flex flex-col justify-center">
                ...
                <div className="projects-container flex flex-col gap-10">
                    ...
                    {projects.map((project) => (
                        <article tabIndex={0} key={project.id} className="text-center flex flex-row items-center gap-12 max-md:flex-col max-sm:w-full max-sm:gap-4">
                            ...
                            <div className="w-1/2 h-[280px] max-lg:h-[180px] max-sm:h-[150px] max-sm:w-full max-sm:px-3 relative">
                                ...
                                <Image src={project.img} alt={project.name} width={600} height={280} className="w-full h-full object-cover" loading="lazy" />
                            </div>
