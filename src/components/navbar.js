const Navbar = () => {
  return (
    <header className="page-header">
      <nav className="bg-transparen relative w-full z-[99999999999] top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="hidden max-[768px]:flex md:order-2">
            <button
