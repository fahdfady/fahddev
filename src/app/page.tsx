...
export default function Home() {
  return (
    <main className="max-w-screen-lg mx-auto  text-left w-full space-y-8">
      ...
      <section aria-label="Information" className="" >
        <ul className="flex flex-col gap-y-3 text-xl font-semibold">
          <li className="flex items-center">
            ...
            Ex-Founding Software Engineer &nbsp;<a href="https://www.oblien.com" className="text-black dark:text-white font-bold" target="_blank">Oblien</a>
          </li>
          <li className="flex items-center">
      ...
      <section aria-label="about" className="space-y-4">
        ...
        <p className="text-xl">Ex-founding SWE <a href="https://x.com/OblienHQ" className="text-black dark:text-white font-bold" target="_blank">Oblien</a>, a tech startup that has upcoming product yet to be announced.</p>
        ...
        <p className="text-xl"> <a href="https://drive.google.com/file/d/1kZV7Ing6HF-Ooxt9pXTtllcGGcG1re1-/view?usp=sharing" target="_blank">link to my resume</a></p>
      </section>
